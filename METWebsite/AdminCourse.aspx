<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminCourse.aspx.cs" Inherits="METWebsite.temp9" %>
        ...
        <div class="successOverlay" id="successOverlay" runat="server" style="display:none">
            <div class="successBox">
                ...
                <div class="successMessage">
                    ...
                    <label class="successLabel">Course is deleted successfully</label>
                </div>
            </div>
        </div>
        <div class="successOverlay" id="failedOverlay" runat="server" style="display:none">
            <div class="successBox">
                ...
                <div class="successMessage">
                    ...
                    <label class="successLabel">Error deleting the course, try again later</label>
                </div>
            </div>
        </div>
    </form>
