<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAlumni.aspx.cs" Inherits="METWebsite.AdminAlumni" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="./StyleSheets/AdminAlumni.css" />
        ...
        <div class="itemsContainer" id="itemsContainer" runat="server">
            ...
            <div class="itemsDiv" id="itemsDiv" runat="server">
                <div class="addItemsDiv">
                    <asp:Button Text="Add Alumni" runat="server" CssClass="addButton" OnClick="AddAlumni" />
                </div>
            </div>
        ...
        <div class="successOverlay" id="successOverlay" runat="server" style="display:none">
            <div class="successBox">
                ...
                <div class="successMessage">
                    ...
                    <label class="successLabel">Alumni is deleted successfully</label>
                </div>
            </div>
        </div>
        <div class="successOverlay" id="failedOverlay" runat="server" style="display:none">
            <div class="successBox">
                ...
                <div class="successMessage">
                    ...
                    <label class="successLabel">Error deleting alumni, try again later</label>
                </div>
            </div>
        </div>
    </form>
