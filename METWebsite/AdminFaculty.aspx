<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminFaculty.aspx.cs" Inherits="METWebsite.AdminFaculty" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="./StyleSheets/AdminFaculty.css" />
        ...
        <div class="itemsContainer" id="itemsContainer" runat="server">
            ...
            <div class="itemsDiv" id="itemsDiv" runat="server">
                <div class="addItemsDiv">
                    <asp:Button Text="Add Faculty" runat="server" CssClass="addButton" OnClick="AddFaculty" />
                </div>
        ...
        <div class="successOverlay" id="successOverlay" runat="server" style="display:none">
            <div class="successBox">
                ...
                <div class="successMessage">
                    ...
                    <label class="successLabel">Faculty is deleted successfully</label>
                </div>
            </div>
        </div>
        <div class="successOverlay" id="failedOverlay" runat="server" style="display:none">
            <div class="successBox">
                ...
                <div class="successMessage">
                    ...
                    <label class="successLabel">Error deleting the faculty, try again later</label>
                </div>
            </div>
        </div>
    </form>
