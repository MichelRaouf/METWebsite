...
<head runat="server">
    ...
    <link rel="stylesheet" href="./StyleSheets/AdminStActivity.css" />
        ...
        <div class="itemsContainer" id="itemsContainer" runat="server">
            ...
            <div class="itemsDiv" id="itemsDiv" runat="server">
                <div class="addItemsDiv">
                    <asp:Button Text="Add Student Activity" runat="server" CssClass="addButton" OnClick="AddStudentActivity" />
                </div>
            </div>
        ...
        <div class="successOverlay" id="successOverlay" runat="server" style="display:none">
            <div class="successBox">
                ...
                <div class="successMessage">
                    ...
                    <label class="successLabel">Student Activity is deleted successfully</label>
                </div>
            </div>
        </div>
        <div class="successOverlay" id="failedOverlay" runat="server" style="display:none">
            <div class="successBox">
                ...
                <div class="successMessage">
                    ...
                    <label class="successLabel">Error deleting student activity, try again later</label>
                </div>
            </div>
        </div>
    </form>
